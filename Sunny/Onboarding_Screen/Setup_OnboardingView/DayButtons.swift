...
class DayButtons: UIView {
    ...
    private func addButtonsToStackView() {
        ...
        todayButton.setTitleColor(UIColor(named: CustomColors.colorVanilla), for: .normal)
//        todayButton.backgroundColor = .white
        ...
        nextTenDaysButton.setTitleColor(UIColor(named: CustomColors.colorDarkBlue1), for: .normal)
